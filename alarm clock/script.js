...
ringtone = new Audio("lokesh-thalod-65732.mp3");
...
function setAlarm() { // if isAlarmSet is true
    if(isAlarmSet) {  // clear the volume of alarmTime
        alarmTime = ""; // pause the ringtone
        ringtone.pause(); 
